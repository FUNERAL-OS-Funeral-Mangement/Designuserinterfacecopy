...
export function LogoUpload({
  ...
  // Rate limiting: Track last upload time
  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (timeSinceLastUpload < UPLOAD_COOLDOWN) {
      const remainingSeconds = Math.ceil((UPLOAD_COOLDOWN - timeSinceLastUpload) / 1000);
      alert(`Please wait ${remainingSeconds} seconds before uploading again.`);
      return;
    }
